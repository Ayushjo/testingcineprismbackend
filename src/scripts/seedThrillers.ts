...
// ─── Movie Data ───────────────────────────────────────────────────────────────
// Fill in synopsis for each movie before running.
// posterImageUrl: leave as "" — the script will auto-fetch from TMDB and upload to S3.
// If you want to supply your own poster URL, paste it in and the TMDB fetch is skipped.
...
const THRILLER_MOVIES: ThrillerMovie[] = [
  {
    title: "Zodiac",
    year: 2007,
