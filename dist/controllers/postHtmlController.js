    ...
    try {
      ...
      `);
        ...
        const sanitizedTitle = (post.title || "Untitled")
            .replace(/"/g, "&quot;")
            .replace(/'/g, "&#39;");
        const sanitizedDescription = post.content && post.content.length > 160
            ? post.content
                .substring(0, 157)
                .replace(/"/g, "&quot;")
                .replace(/'/g, "&#39;") + "..."
      ...
      <head>
        ...
        <meta property="article:tag" content="${post.genres?.join(", ") || "Movie"}" />
      ...
      <body>
        <div class="container">
          ...
          <div class="movie-info">
            ...
            ? `<div class="info-item"><span class="info-label">Genres:</span> <span class="info-value">${post.genres.join(", ")}</span></div>`
            : ""}
          </div>
